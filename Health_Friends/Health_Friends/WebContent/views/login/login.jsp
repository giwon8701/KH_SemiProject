	...
	<div class="container">
		<div class="forms-container">
			<div class="signin-signup">
				<!-- 로그인 form -->
				<form action="../../regist.do" class="sign-in-form" method="post"
					id="loginForm">
					<input type="hidden" name="command" value="loginres">
					<h2 class="title">로그인</h2>
					<div class="input-field">
						<i class="fas fa-user"></i> <input type="text"
							name="loginMemberId" placeholder="아이디를 입력해주세요">
					</div>
					<div class="input-field">
						<i class="fas fa-lock"></i> <input type="password"
							name="loginMemberPw" placeholder="비밀번호를 입력해주세요">
					</div>
					<input type="button" value="로그인" class="btn solid g-recaptcha"
						data-sitekey="6LdY0Y0aAAAAAC55f1G3fyahKgyATLdZ1BZq_yt5"
						data-callback='onSubmitLogin' data-action='submit'>
				...
				<form action="../../regist.do" method="post" id="registform"
						...
						<tr>
							<div class="input-field">
								<i class="fas fa-user"></i> <input type="text" id="id"
									name="memberId" title="n" placeholder="아이디입력"
									required="required" onchange="idCheck()">
							</div>
						</tr>
						<tr>
					...
					<table>
						<tr>
							<div class="input-field">
								<i class="fas fa-lock"></i> <input type="password" id="pw"
									name="memberPw" placeholder="비밀번호" required="required"
									onchange="chkPW()">
							</div>
						</tr>
						<tr>
							<div class="input-field">
								<i class="fas fa-lock"></i> <input type="password" id="pwchk"
									name="memberPwChk" title="n" placeholder="비밀번호 확인"
									required="required" onchange="chkPW()">
							</div>
						</tr>
						<tr>
					...
					<table>
						<tr>
							<div class="input-field">
								<i class="fas fa-home"></i> <input type="text" id="addr"
									name="memberAddr" placeholder="주소를 입력해주세요" readonly="readonly"
									required="required" onclick="addrCheck()">
							</div>
						</tr>
						...
						<tr>
							<div class="input-field">
								<i class="fas fa-user"></i> <input type="text" id="name"
									name="memberName" placeholder="이름" required="required">
							</div>
						</tr>
					</table>
						...
						<tr>
							<div class="input-field">
								<i class="fas fa-phone"></i> <input type="tel" id="phone"
									name="memberPhone" title="n" placeholder="전화번호"
									onchange="phoneChk()" required="required">
							</div>
						</tr>
						<tr>
						...
						<tr>
							<div class="input-field">
								<i class="fas fa-envelope"></i> <input type="text" id="email"
									name="memberEmail" title="n" placeholder="이메일"
									required="required" onchange="emailChk()">
							</div>
						</tr>
						<tr>
					...
					<table>
						<tr>
							<td><input type="button" class="btn solid g-recaptcha"
								data-sitekey="6LdY0Y0aAAAAAC55f1G3fyahKgyATLdZ1BZq_yt5"
								data-callback='onSubmit' data-action='submit' value="회원가입">
							</td>
							<td><input type="button" value="취소" class="btn solid"
					...
					<table>
						<tr>
							...
							<div class="social-media">
								<a href="<%=apiURL%>" class="naver-icon"> <img
									src="https://s.pstatic.net/static/www/u/2014/0328/mma_20432863.png"
									class="naver-icon">
								</a> <a id="kakaologin" href="javascript:loginWithKakao()"
									class="kakao-icon"> <img
									src="https://t1.kakaocdn.net/kakaocorp/admin/main-banner/123"
									class="kakao-icon">
								</a>
							</div>
						</tr>
