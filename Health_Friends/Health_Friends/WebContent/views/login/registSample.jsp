				...
				<table>
					...
					<tr>
						<td colspan="2">
							...
							<input type="password" id="pw" name="memberPw" placeholder="비밀번호" required="required" onkeyup="chkPW()">
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<input type="password" id="pwchk" name="memberPwChk" title="n" placeholder="비밀번호 확인" required="required" onkeyup="chkPW()">
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2">
							...
							<input type="text" id="email" name="memberEmail" title="n" placeholder="이메일" required="required" onkeyup="emailChk()"></td>
					</tr>
					<tr>
			...
			<c:otherwise>
				...
				<table>
					...
					<tr>
						<td colspan="2">
							<label for="email">이메일</label><br>
							<input type="text" id="email" name="memberEmail" title="y" value="${dto.member_email }" readonly="readonly" required></td>
					</tr>
					<tr>
						<td colspan="2">
							<button class="g-recaptcha" 
