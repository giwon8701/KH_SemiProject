...
INSERT INTO MEMBER
VALUES(MEMBERNOSEQ.NEXTVAL, 'manager', 'manager', '관리자', '20000101', 'F', 'system@member.com', '01000000000',
	   'Y', 0, 'MANAGER');

SELECT MEMBER_NO, MEMBER_ID, MEMBER_PW, MEMBER_NAME, MEMBER_BIRTHDAY, MEMBER_GENDER
